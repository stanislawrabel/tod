...
OTA_COMMON="ota_common.txt"

{
  echo "MODEL=$clean_model"
  echo "REGION=$region_code"
  echo "OTA=$ota_version_full"
  echo "ANDROID=$android_version"
  echo "OS=$os_version"
  echo "PATCH=$security_os"
  echo "VERSION=$version_type_id"
  echo "LOCAL_INSTALL=$(echo "$forbid_status" | sed 's/[^A-Z]//g')"
  echo "ABOUT=$about_update_url"
  echo "DOWNLOAD=$FINAL_ZIP_URL"
  echo "---"
} >> "$OTA_COMMON"
